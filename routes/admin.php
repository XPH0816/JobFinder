...
Route::middleware('admin')->prefix('dashboard')->group(function () {
    ...
    Route::view('/employer/register', 'admin.employers.create')->name('adminEmpRegister');
    Route::post('/employer/register', [DashboardController::class, 'storeEmployer'])->name('adminEmpStore');
