...
Route::post('/approve/{application}', [JobController::class, 'approve'])->name('approve');
Route::post('/reject/{application}', [JobController::class, 'reject'])->name('reject');
...
// Payment Route
Route::post('/payment-intent', [PaymentController::class, 'index'])->name('payment-intent');
Route::post('/payment/{id}', [PaymentController::class, 'singleCharge'])->name('single.charge');
