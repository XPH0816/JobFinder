                    ...
                    <div class="row align-items-center">
                        <div class="col-2">
                            <h2 class="mb-0 site-logo">
                                {{-- <a href="/">Job<strong class="font-weight-bold">Finder</strong></a> --}}
                            ...
                            <nav class="site-navigation text-right" role="navigation">
                                <div class="container pr-0">
                                    ...
                                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                                        ...
                                        <li class="{{ request()->routeIs('company') ? 'active' : '' }}"><a
                                                href="{{ route('company') }}">Company</a></li>
                                        @if (!Auth::check())
                                            <li class="{{ request()->routeIs('/register') ? 'active' : '' }}"><a
                                                    href="/register">For Job Seeker</a></li>
                                            <li class="{{ request()->routeIs('employer.register') ? 'active' : '' }}"><a
                                                    href="{{ route('employer.register') }}">For Employees</a></li>
                                        @else
                                        ...
                                        @if (!Auth::check())
                                            <li>
                                                <a href="#" data-bs-target="#login-modal" data-toggle="modal"
                                                    data-target="#login-modal"><span
                                                        class="bg-primary text-white py-3 px-3 rounded"><span
                                                            class="icon-sign-in mr-3"></span>Login</span></a>
                                            </li>
                                        @else
                                            <li>
                                                <a class="bg-primary text-white py-3 px-3 rounded"
                                                    href="{{ route('logout') }}"
