...
class JobController extends Controller
{
    ...
    public function apply(Request $request, $id)
    {
        ...
        $application = Application::where('user_id', auth()->user()->id)->where('job_id', $id)->first();
        $application->services()->sync($request->services);
    ...
    public function reject(Application $application)
    {
        ...
        $invoice = $application->user->invoices()->first(function ($item) use ($application) {
            return $item->id == $application->invoice_id;
        });
        $application->user->refund($invoice->payment_intent);
        $application->save();
